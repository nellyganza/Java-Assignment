...
public class bookView extends javax.swing.JInternalFrame {
    ...
    private void savebookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_savebookActionPerformed
        ...
        b.setPages(BigDecimal.valueOf(Double.valueOf(numofpage.getValue().toString())));
        b.setNumberofcopies(BigDecimal.valueOf(Double.valueOf(numofcopy.getValue().toString())));
        bdao.saveBook(b);
        populateBook();
